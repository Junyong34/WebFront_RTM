Ext.define('RTM.EED.rtmAlarmList', {
    ...
    createAlarmGrid: function() {
        ...
        try {
            this.grid.addColumn('시간'                   , 'A1'          ,  110, Grid.DateTime, true,  false);
            ...
            this.grid.addColumn('트랜잭션'               , 'A7'   , 240, Grid.String  , true,  false);
            this.grid.addColumn('상태'                   , 'A8'   , 100, Grid.Float   , true,  false);
            this.grid.addColumn('값'                     , 'A9'         , 100, Grid.Float   , true,  false);    // 5

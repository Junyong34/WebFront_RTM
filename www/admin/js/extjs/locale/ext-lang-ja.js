...
Ext.define("Ext.locale.ja.grid.header.Container", {
    ...
    sortAscText: "昇順で並べ替え", //"昇順",
    sortDescText: "降順で並べ替え", //"降順",
    columnsText: "カラム表示" //"カラム"
});

Ext.define("Ext.locale.ja.grid.locking.Lockable", {
...
Ext.define("Ext.locale.ja.ux.grid.FiltersFeature", {
    override: "Ext.ux.grid.FiltersFeature",
    menuFilterText: "フィルター"
});

Ext.define("Ext.locale.ja.TabCloseMenu", {
    override: "Ext.ux.TabCloseMenu",
    closeTabText: "タブを閉じる",
    closeOthersTabsText: "他のタブを閉じる",
    closeAllTabsText: "すべてのタブを閉じる"
});

Ext.define("Ext.locale.ja.panel.Table", {

...
//            var html = Ext.create('Ext.XTemplate', htmlMarkup).apply(data);
            ...
            if (this.windowOption === true) {
                win = window.open('', this.windowName, this.windowSpecs);
            } else {
                win = window.open('', this.windowName);
            }
...
//        },
        ...
        printLinkText: 'Print',
         ...
         /**
          * Add Lee suk min - 2013.11.27
         * Show print link
		 * @property enablePrintLinkText
         * @type String
         */
        enablePrintLinkText: true,
         ...
         * Add Lee suk min - 2013.11.27
         * Show close link
		 * @property enableCloseLinkText
         * @type String
         */
        enableCloseLinkText: true,
